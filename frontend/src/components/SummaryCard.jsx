...
const SummaryCard = ({expenses}) => {
  ...
  return (
    <div className='flex justify-center items-center lg:gap-15  lg:mx-40  pt-9'>
      <div className='bg-emerald-700 shadow-md border-l-6 border-emerald-900 shadow-zinc-500 p-8 lg:w-[30%] md:w-[80%] m-6 rounded-xl' >
    ...
    <div className='bg-white shadow-md border-l-6 border-emerald-900 shadow-zinc-500 p-8 lg:w-[30%] md:w-[80%] m-6 rounded-xl' >
    ...
    <div className='bg-white shadow-md border-l-6 border-red-600 shadow-zinc-500 p-8 lg:w-[30%] md:w-[80%] m-6 rounded-xl' >
